...
$roomId = 11; // Default to room 1 for this example
...
// ... on line 12
// Corrected query for villa3.php:
...
<head>
    ...
    <title>Royal Suite Villa | Royal Star Resort</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="../home.php#rooms">Rooms & Villas</a></li>
    ...
    <section class="hero-section">
        <img src="../photos/villa3.jpeg" alt="Royal Suite Villa" class="hero-image">
        <div class="hero-overlay"></div>
        <div class="container hero-content">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="room-title">Royal Suite Villa</h1>
                    <p class="hero-subtitle">Indulge in our most luxurious accommodation, featuring dedicated private butler service and a stunning infinity pool.</p>
                    
                    <div class="price-tag">
                        <span class="price-amount">₹21000</span>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="review-count">(210 reviews)</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <section class="mb-5">
                        <h2 class="section-title">The Epitome of Luxury</h2>
                        <p>The Royal Suite Villa is the crown jewel of our resort, offering an unparalleled experience of opulence and exclusivity. This is our most luxurious accommodation, meticulously designed for those who accept nothing but the best. Every aspect of your stay is personalized with a dedicated private butler service.</p>
                        <p>Spanning an expansive 2500 square feet, this magnificent villa boasts multiple master suites, a grand living area, a gourmet kitchen, and a spectacular private terrace with its own infinity pool overlooking the breathtaking landscape. It is a true sanctuary of comfort, privacy, and sophistication.</p>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4 mb-3">
                                <div class="amenity-item">
                                    ...
                                    <div>
                                        <h5 class="mb-0">2500 sq.ft</h5>
                                        <small>Villa Size</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            ...
                                            <small>24/7 personal butler</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                                        ...
                                        <div>
                                            <h5 class="mb-0">Gourmet Kitchen</h5>
                                            <small>Fully equipped</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                                        ...
                                        <div>
                                            <h5 class="mb-0">Private Spa</h5>
                                            <small>In-villa treatments</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                                        ...
                                        <div>
                                            <h5 class="mb-0">VIP Service</h5>
                                            <small>Exclusive privileges</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section class="mb-5">
                        ...
                        <div class="gallery-container">
                            <div class="main-image">
                                <img src="../photos/villa3.jpeg" alt="Royal Suite Villa" class="gallery-img w-100 h-100">
                            </div>
                            <div class="thumbnail-container">
                                <div class="thumbnail active">
                                    <img src="../photos/hall.jpg" alt="Villa Hallway">
                                </div>
                                <div class="thumbnail">
                                    <img src="../photos/gallery1.jpg" alt="Bathroom">
                                </div>
                                <div class="thumbnail">
                                    <img src="../photos/gallery2.jpg" alt="Pool View">
                                </div>
                                <div class="thumbnail">
                ...
                <div class="col-lg-4">
                    <div class="card policy-card mb-4">
                        <div class="card-body">
                            <h4 class="section-title">Reserve Your Villa</h4>
                            <form id="bookingForm">
                                <div class="mb-3">
                    ...
                    <div class="card policy-card">
                        <div class="card-body">
                            <h4 class="section-title">Villa Policies</h4>
                                ...
                                <li>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <small>Allowed in outdoor areas only</small>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="card policy-card mt-4">
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning">
                                ...
                                <p class="small">Book 7 nights or more and receive 25% off your entire stay!</p>
                            </div>
                            <div class="alert alert-info">
                                <h5><i class="fas fa-crown me-2"></i> Royal Indulgence Package</h5>
                                <p class="small">Includes private chef services, daily spa treatments, and a luxury car at your disposal.</p>
                            </div>
                        </div>
                    </div>
                </div>
