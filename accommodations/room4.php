...
$roomId = 3; // Default to room 1 for this example
...
<head>
    ...
    <title>Jacuzzi 180-Degree Suite | Royal Star Resort</title>
...
<body>
    ...
    <section class="hero-section">
        <img src="../photos/rm8.jpeg" alt="Jacuzzi 180-Degree Suite" class="hero-image">
        <div class="hero-overlay"></div>
        <div class="container hero-content">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="room-title">Jacuzzi 180-Degree Suite</h1>
                    <p class="hero-subtitle">Indulge in ultimate luxury and privacy with breathtaking 180-degree views from your personal outdoor jacuzzi.</p>
                    
                    <div class="price-tag">
                        <span class="price-amount">₹8700</span>
    ...
    <main class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <section class="mb-5">
                        <h2 class="section-title">Unrivaled Views and Relaxation</h2>
                        <p>The Jacuzzi 180-Degree Suite is a high-end retreat designed for guests seeking unparalleled luxury, privacy, and breathtaking panoramic views. This suite is defined by its spectacular outdoor jacuzzi, offering an immersive experience of the surrounding landscape.</p>
                        <p>At 750 square feet, this suite provides ample space with elegant interiors, a plush king-sized bed, and a comfortable seating area. The seamless transition from the indoor space to the private outdoor deck creates a perfect sanctuary for relaxation and romance.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            <h5 class="mb-0">180-Degree View</h5>
                                            <small>Unobstructed panoramic sights</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                                    ...
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            <h5 class="mb-0">Private Jacuzzi</h5>
                                            <small>Outdoor heated whirlpool</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                    ...
                    <section class="mb-5">
                        ...
                        <div class="gallery-container">
                            <div class="main-image">
                                <img src="../photos/rm8.jpeg" alt="Jacuzzi 180-Degree Suite" class="gallery-img w-100 h-100">
                            </div>
                                ...
                                <li class="mb-3">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <small>This suite is for adults only</small>
                                        </div>
                                    </div>
                                </li>
                                <li class="mb-3">
                    ...
                    <div class="card policy-card mt-4">
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                <h5><i class="fas fa-umbrella-beach me-2"></i> Romance Package</h5>
                                <p class="small">Complimentary champagne, flowers, and spa credit.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="../Guest&Public_Pages/reservation.php" class="btn room-btn">Book Now</a>
        </div>
    </main>
