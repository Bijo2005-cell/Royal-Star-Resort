...
$roomId = 7; // Default to room 1 for this example
...
<head>
    ...
    <title>Superior Room | Royal Star Resort</title>
...
<body>
    ...
    <section class="hero-section">
        <img src="../photos/rm2.jpg" alt="Superior Room" class="hero-image">
        <div class="hero-overlay"></div>
        <div class="container hero-content">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="room-title">Superior Room</h1>
                    <p class="hero-subtitle">Elevate your stay in our stylish Superior Room, thoughtfully designed for the perfect blend of comfort and convenience.</p>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="rating-badge">
                            ...
                            <span class="review-count">4.2/5</span>
                        </div>
                        <span class="review-count">(285 reviews)</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <section class="mb-5">
                        <h2 class="section-title">Stylish Comfort, Modern Convenience</h2>
                        <p>Our Superior Room offers a stylish and inviting space, thoughtfully designed to ensure a comfortable and convenient stay. This room is an excellent choice for travelers seeking modern amenities and a relaxing atmosphere.</p>
                        <p>Covering 450 square feet, the room is efficiently laid out to maximize comfort. It features contemporary decor, a choice of comfortable bedding, and all the essential amenities needed for a pleasant and hassle-free visit.</p>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            ...
                                            <small>Smart TV with streaming</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                    ...
                    <section class="mb-5">
                        ...
                        <div class="gallery-container">
                            <div class="main-image">
                                <img src="../photos/rm2.jpg" alt="Superior Room" class="gallery-img w-100 h-100">
                            </div>
