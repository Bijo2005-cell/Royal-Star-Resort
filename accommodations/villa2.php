...
$roomId = 10; // Default to room 1 for this example
...
// ... on line 12
// Corrected query for villa2.php:
...
<head>
    ...
    <title>Dam Front Villa | Royal Star Resort</title>
...
<body>
    ...
    <section class="hero-section">
        <img src="../photos/villa2.jpeg" alt="Dam Front Villa" class="hero-image">
        <div class="hero-overlay"></div>
        <div class="container hero-content">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="room-title">Dam Front Villa</h1>
                    <p class="hero-subtitle">Experience direct access to the water's edge with stunning dam and lake views from every room of this exclusive villa.</p>
                    
                    <div class="price-tag">
                        <span class="price-amount">₹14000</span>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="review-count">(170 reviews)</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <section class="mb-5">
                        <h2 class="section-title">Unforgettable Waterfront Living</h2>
                        <p>Our Dam Front Villa offers a unique and immersive experience, positioned directly at the water's edge. This luxurious residence provides unparalleled, stunning views of the dam and tranquil waters from every room, creating a serene and picturesque backdrop for your stay.</p>
                        <p>This spacious 1500 square foot villa is designed for those who appreciate nature and luxury. It features expansive floor-to-ceiling windows, a large private terrace, and direct access to the waterfront. The interiors are elegantly appointed, offering a perfect blend of comfort and style for an unforgettable retreat.</p>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="amenity-item">
                                    ...
                                    <div>
                                        <h5 class="mb-0">Waterfront Access</h5>
                                        <small>Direct to Dam</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            ...
                                            <small>Complimentary selection</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            <h5 class="mb-0">Panoramic Views</h5>
                                            <small>Dam and lake vistas</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                    ...
                    <section class="mb-5">
                        ...
                        <div class="gallery-container">
                            <div class="main-image">
                                <img src="../photos/villa2.jpeg" alt="Dam Front Villa" class="gallery-img w-100 h-100">
                            </div>
                            <div class="thumbnail-container">
                                ...
                                <div class="thumbnail">
                                    <img src="../photos/gallery2.jpg" alt="Terrace View">
                                </div>
                                <div class="thumbnail">
                                ...
                                <li>
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <small>Allowed on outdoor terrace only</small>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="card policy-card mt-4">
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning">
                                ...
                                <p class="small">Book 5 nights or more and receive 20% off your entire stay!</p>
                            </div>
                            <div class="alert alert-info">
                                <h5><i class="fas fa-water me-2"></i> Waterside Adventure Package</h5>
                                <p class="small">Includes a complimentary boat tour and picnic by the dam.</p>
                            </div>
                        </div>
                    </div>
                </div>
