...
$roomId = 5; // Default to room 1 for this example
...
<head>
    ...
    <title>Honeymoon Suite | Royal Star Resort</title>
...
<body>
    ...
    <section class="hero-section">
        <img src="../photos/rm6.jpeg" alt="Honeymoon Suite" class="hero-image">
        <div class="hero-overlay"></div>
        <div class="container hero-content">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="room-title">Honeymoon Suite</h1>
                    <p class="hero-subtitle">Escape into a world of romance and luxury in our suite, thoughtfully designed for newlyweds and couples celebrating love.</p>
                    
                    <div class="price-tag">
                        <span class="price-amount">₹6700</span>
    ...
    <main class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <section class="mb-5">
                        <h2 class="section-title">A Sanctuary for Two</h2>
                        <p>Our Honeymoon Suite is a private haven of romance and luxury. Thoughtfully designed for newlyweds and couples, this suite provides an intimate setting to celebrate your love. The atmosphere is one of serene elegance, with soft lighting, plush furnishings, and exquisite decor.</p>
                        <p>Spanning 720 square feet, the suite features a romantic king-sized bed, a cozy living area perfect for two, and a private balcony with enchanting views. The spa-inspired bathroom, complete with a deep soaking tub, invites you to unwind and relax together.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            <h5 class="mb-0">Romantic Ambiance</h5>
                                            <small>Special decor and lighting</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                                    ...
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            ...
                                            <small>Deep soaking tub for two</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                    ...
                    <section class="mb-5">
                        ...
                        <div class="gallery-container">
                            <div class="main-image">
                                <img src="../photos/rm6.jpeg" alt="Honeymoon Suite" class="gallery-img w-100 h-100">
                            </div>
                    ...
                    <div class="card policy-card mt-4">
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                ...
                                <p class="small">Complimentary champagne, flowers, and spa credit for honeymooners.</p>
                            </div>
                        </div>
                    </div>
                </div>
