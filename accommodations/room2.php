...
$roomId = 1; // Default to room 1 for this example
...
<head>
    ...
    <title>Premium Club Suite | Royal Star Resort</title>
...
<body>
    ...
    <section class="hero-section">
        <img src="../photos/rm5.jpeg" alt="Premium Club Suite" class="hero-image">
        <div class="hero-overlay"></div>
        <div class="container hero-content">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="room-title">Premium Club Suite</h1>
                    <p class="hero-subtitle">Experience luxury in a spacious club suite with stunning valley views, modern decor, and a private balcony.</p>
    ...
    <main class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <section class="mb-5">
                        <h2 class="section-title">A Luxurious Stay with Valley Views</h2>
                        <p>Our Premium Club Suite offers an unparalleled experience of comfort and elegance. Spanning 750 square feet, this suite is designed with modern decor, featuring a spacious layout that is perfect for a luxurious and relaxing stay.</p>
                        <p>Enjoy breathtaking views of the valley from your private balcony. The suite includes a comfortable king-sized bed, a separate living area, and a state-of-the-art bathroom, ensuring a memorable and restful retreat.</p>
                    ...
                    <section class="mb-5">
                        ...
                        <div class="gallery-container">
                            <div class="main-image">
                                <img src="../photos/rm5.jpeg" alt="Premium Club Suite" class="gallery-img w-100 h-100">
                            </div>
