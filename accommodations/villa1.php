...
$roomId = 9; // Default to room 1 for this example
...
// ... on line 12
// Corrected query for villa1.php:
...
<head>
    ...
    <title>Garden Villa | Royal Star Resort</title>
...
<body>
    ...
    <section class="hero-section">
        <img src="../photos/villa1.jpeg" alt="Garden Villa" class="hero-image">
        <div class="hero-overlay"></div>
        <div class="container hero-content">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="room-title">Garden Villa</h1>
                    <p class="hero-subtitle">Escape to a private villa surrounded by lush tropical gardens, complete with your own exclusive plunge pool.</p>
                    
                    <div class="price-tag">
                        <span class="price-amount">₹17200</span>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="review-count">(155 reviews)</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main class="content-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <section class="mb-5">
                        <h2 class="section-title">Your Private Garden Oasis</h2>
                        <p>Discover a sanctuary of tranquility in our Garden Villa. This standalone residence offers the ultimate in privacy and luxury, nestled within its own lush, tropical garden. It's the perfect escape for those seeking a serene and intimate getaway.</p>
                        <p>Spanning an impressive 1200 square feet, the villa features spacious living and sleeping areas with elegant decor. The highlight is the private outdoor space, which includes a sundeck and a refreshing plunge pool, allowing you to relax and unwind in complete seclusion.</p>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="amenity-item">
                                    ...
                                    <div>
                                        <h5 class="mb-0">Private Pool</h5>
                                        <small>Plunge Pool</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            <h5 class="mb-0">Private Garden</h5>
                                            <small>Lush tropical surroundings</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                                    ...
                                    <div class="amenity-item">
                                        ...
                                        <div>
                                            ...
                                            <small>Outdoor rain shower</small>
                                        </div>
                                    </div>
                                    <div class="amenity-item">
                                        <div class="amenity-icon">
                    ...
                    <section class="mb-5">
                        ...
                        <div class="gallery-container">
                            <div class="main-image">
                                <img src="../photos/villa1.jpeg" alt="Garden Villa" class="gallery-img w-100 h-100">
                            </div>
                    ...
                    <div class="card policy-card mt-4">
                        <div class="card-body">
                            ...
                            <div class="alert alert-info">
                                <h5><i class="fas fa-spa me-2"></i> Villa Indulgence Package</h5>
                                <p class="small">Includes daily private breakfast, a couples massage, and late checkout.</p>
                            </div>
                        </div>
                    </div>
                </div>
