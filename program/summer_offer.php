...
// Fetch all programs of type 'offer' that are currently valid
$today = date("Y-m-d");
$stmt = $conn->prepare("SELECT * FROM programs WHERE type = 'offer' AND (valid_to >= ? OR valid_to IS NULL)");
...
<head>
    ...
    <title>Royal Star Resort - Summer Escape Offer</title>
...
<body>
    ...
    <header id="home" class="hero7">
        <div class="container text-center">
             <div class="d-flex justify-content-center align-items-center mb-3">
                 <h1 class="mx-4">Your Ultimate Summer Escape</h1>
             </div>
            <p class="lead">Enjoy exclusive offers on our all-inclusive summer packages.</p>
            <a href="#booking" class="btn btn-gold mt-3">Book Your Getaway</a>
        </div>
    </header>
    ...
    <main>
        <section id="package" class="py-5">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-title">Summer Escape Special Offers</h2>
                    <p class="section-subtitle">Everything you need for a perfect sun-soaked vacation.</p>
                </div>
                <div class="row g-4 justify-content-center">
                                    ...
                                    <h4 class="price-tag">
                                        <?php 
                                            if (is_numeric($program['price'])) {
                                                echo 'From ₹' . htmlspecialchars(number_format($program['price'])) . ' / night';
                                            } else {
                    ...
                    <?php else: ?>
                        <div class="col-12 text-center">
                            <p class="lead">No summer offers are currently available. Please check back soon!</p>
                        </div>
                    <?php endif; ?>
        ...
        <section class="py-5 bg-sienna">
            <div class="container text-center">
                <h2 class="mb-3">Your Perfect Summer Is Just a Click Away!</h2>
                <p class="lead mb-4">Book now to lock in exclusive rates and offers.</p>
                <a href="#booking" class="btn btn-gold">Lock In Your Offer</a>
            </div>
        </section>
        ...
        <section id="gallery" class="py-5">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-title">Summer Memories</h2>
                    <p class="section-subtitle">See the unforgettable moments from our guests' summer stays.</p>
                </div>
                <div class="row g-4">
                    <div class="col-md-4"><img src="../photos/bg2.jpg" class="img-fluid gallery-img" alt="Gallery Image 1"></div>
        ...
        <section id="booking" class="py-5 bg-light">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-title">Book Your Summer Escape</h2>
                    <p class="section-subtitle">Fill out the form below to inquire about our special summer offer.</p>
                </div>
                                    ...
                                    <div class="col-12 text-center">
                                        ...
                                        <script>
                                            document.querySelector('.booking-form form').addEventListener('submit', function(e) {
                                                ...
                                                const summerOfferId = 8; // program_id for 'Summer Escape Special'
                                                const roomId = 1;        // acc_id for 'Premium Club Suite'

                                                // 3. Build the URL and redirect
                                                const url = `/miniproject/Guest&Public_Pages/reservation.php?roomId=${roomId}&packageId=${summerOfferId}`;
